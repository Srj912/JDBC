...
public class Booking extends javax.swing.JFrame {
        ...
        if (f == 1) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    mode = rs.getString("payment");
                    dbname = rs.getString("username");
                    pickup = rs.getString("pickup");
                    destination = rs.getString("destination");
                    fare = rs.getInt(8);
                    distance = rs.getInt(10);
                    //System.out.println("faf");
                }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            PreparedStatement ps = connect.prepareStatement("select driver_id,model,rating from available where curr_location=? and stime<? and ?<etime");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            query1 = "insert into bookings(bookingid,username,drivername,bookingdate,departure,pickup,destination,fare,payment,kms,bookingtime) values(?,?,?,?,?,?,?,?,?,?,?)";
            ps = connect.prepareStatement(query1);
            ps.setInt(1,bkid);
            ps.setString(2, s);
            ...
            ps.setString(6, jComboBox4.getItemAt(jComboBox4.getSelectedIndex()));
            ps.setString(7, jComboBox2.getItemAt(jComboBox2.getSelectedIndex()));
            ps.setInt(8, Integer.parseInt(jLabel27.getText()));
            ps.setString(9, "Cash");
            ps.setInt(10, Integer.parseInt(jTextField1.getText()));
            ps.setString(11, str_time);
            ps.execute();
