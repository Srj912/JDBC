...
public class Driver_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ride_b.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ride_b.setForeground(new java.awt.Color(255, 0, 0));
        ...
        ridehis_b.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ridehis_b.setForeground(new java.awt.Color(255, 0, 0));
        ...
        logout_b.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        logout_b.setForeground(new java.awt.Color(255, 0, 0));
        ...
        profile_b.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        profile_b.setForeground(new java.awt.Color(255, 0, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jSplitPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 993, Short.MAX_VALUE)
        );
    ...
    private void ridehis_bActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ridehis_bActionPerformed
        ...
        try {
            ...
            model.setRowCount(0);
            PreparedStatement ps = conn.prepareStatement("select * from bookings where drivername=? ");
            ps.setString(1, dbname);
            System.out.print("\nhello"+dbname);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                System.out.print("hello"+rs.getInt(1));
                model.addRow(new Object[]{rs.getString(4), rs.getString(2),rs.getString(6),rs.getString(5),rs.getString(7),rs.getInt(8)});
                // TODO add your handling code here:
